...
const Testing = () => {
  ...
  return (
    <div className="container flex items-center flex-col justify-center px-5">
      <div className="max-w-[640px]  rounded-[40px] flex items-start flex-col justify-start gap-[20px]  relative">
        ...
        <form
          ...
          className="flex items-center flex-col w-full gap-[10px]"
        >
          <div className="w-full flex items-center gap-x-[20px] flex-col">
        ...
        <p className="text-[15px] text-start text-gray-500">
          Нажимая кнопку «Отправить», вы даете свое конкретное, информированное
          и сознательное согласие на обработку и хранение ваших персональных
